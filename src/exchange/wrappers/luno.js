...
const includes = (str, list) => {
  ...
  const result = _.some(list, item => str.includes(item))
  return result
}
...
Trader.prototype.getFee = function (callback) {
  ...
  if (this.pair === 'ETHXBT') { return callback(undefined, 0.000025) } else if (this.pair === 'XBTIDR') { return callback(undefined, 0.00002) } else { return callback(undefined, 0.0001) }
