...
Actor.prototype = {
  ...
  textHasCommandForBot: function (text, nickname, handler) {
    ...
    var normalizedNickname = nickname.toLowerCase()
    var normalizedHandler = handler.toLowerCase()

    var nicknameWasMentioned = normalizedText.indexOf(normalizedNickname) >= 0
    var handlerWasMentioned = normalizedText.indexOf(normalizedHandler) >= 0
