...
var PERSISTENCE_SELL = 2//
var PERSISTENCE_BUY = 2//
var PERSISTENCE_CANDLE_HIGH = 3////   минимальное значение для подсчета PERSISTENCE
...
strat.update = function(candle) {
  log.debug('strat.update tVStrat224.100.OSCcor22_2_2_3sl10')//
