...
var PERSISTENCE_CANDLE_HIGH = 4////   минимальное значение для подсчета PERSISTENCE

var PERSISTENCE_SELL = 6//
var PERSISTENCE_BUY = 6//
...
//var M15_SUM_SELL, M15_SUM_SELL_LAST, M15_SUM_NEUTRAL,M15_SUM_NEUTRAL_LAST, M15_SUM_BUY,M15_SUM_BUY_LAST//
var M15_OSC_SELL, M15_OSC_NEUTRAL, M15_OSC_BUY
//var M15_MA_SELL, M15_MA_NEUTRAL, M15_MA_BUY
        ...
        var M15_string = fileContent.match(/M15\{.\"data\"\:\[.*?\]/g)//
          if (Array.isArray(M15_string)){
           // log.debug("M15_string "+M15_string[0])//
            var M15_string_cut = M15_string[0].substring(40, M15_string[0].length-1)// 
           // log.debug("M15_string_cut "+M15_string_cut)//
            var indicators = M15_string_cut.split(',')
            ...
            if (indicators.length == 82){
                ...
                log.debug("M15_OSC_BUY "+M15_OSC_BUY)//
                log.debug("M15_OSC_SELL "+M15_OSC_SELL)//
                log.debug("M15_OSC_NEUTRAL "+M15_OSC_NEUTRAL)//
                ...
                if (price >0){ 
                    ...
                    historyB[1] = M15_OSC_BUY//
                    historyS[1] = M15_OSC_SELL//
                    ...
                    historyBDiff = M15_OSC_BUY - historyBMin//
                    historySDiff = M15_OSC_SELL - historySMin//
                    ...
                    M15_OSC_BUY_LAST = M15_OSC_BUY//
                    M15_OSC_SELL_LAST = M15_OSC_SELL//
  ...
  if (bad_data) log.debug('bad data') 
            ...
            if (sellPrice > 0) {
                if (price < trailingPrice){
                    trailingPrice = price
                    //#print("MOVE trailingPrice to " + str(trailingPrice))
                }
                if (price < sellPrice){
