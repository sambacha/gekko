...
*/
  ...
  let fileContent = fs.readFileSync(fileName, "utf8");
        ...
        log.debug("1H_SUM_SELL "+signal_sell_pos+" "+signal_sell_int);
        ...
        log.debug("1H_SUM_NEUTRAL "+signal_neutral_pos+" "+signal_neutral_int);
        ...
        log.debug("1H_SUM_BUY "+signal_buy_pos+" "+signal_buy_int);
